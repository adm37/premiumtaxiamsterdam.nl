...
export const metadata: Metadata = getLocationMetadata('Diemen', '/diemen');

export default function DiemenPage() {
  return (
            ...
            <div className="max-w-4xl mx-auto">
              <div className="mb-12">
                ...
                <h1 className="text-5xl md:text-7xl font-black text-neutral-900 uppercase tracking-tighter mb-6">
                  Taxi <span className="text-red-600">Diemen</span>
                </h1>
                <p className="text-neutral-500 text-lg md:text-xl font-medium max-w-3xl">
                  Premium Taxi Amsterdam rijdt ook snel en betrouwbaar in Diemen. Vaste scherprijzen van en naar Amsterdam en Schiphol.
                </p>
              </div>

              <div className="grid md:grid-cols-2 gap-8 mb-16">
                <div className="bg-neutral-50 p-8 rounded-sm border border-neutral-200">
                  <h2 className="text-2xl font-black text-neutral-900 uppercase tracking-tighter mb-6">Service in Diemen</h2>
                  <ul className="space-y-4 text-neutral-600 font-medium">
                    <li className="flex gap-3">
                      <span className="text-red-600 font-black">✓</span>
                      <span>Snelle verbinding naar Amsterdam</span>
                    </li>
                    <li className="flex gap-3">
                      <span className="text-red-600 font-black">✓</span>
                      <span>Schiphol taxi €55 vast</span>
                    </li>
                    <li className="flex gap-3">
                      <span className="text-red-600 font-black">✓</span>
                      <span>Professionele chauffeurs</span>
                    </li>
                    <li className="flex gap-3">
                      <span className="text-red-600 font-black">✓</span>
                      <span>Luxe auto's beschikbaar</span>
                    </li>
                    <li className="flex gap-3">
                      <span className="text-red-600 font-black">✓</span>
                      <span>Dag en nacht open</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-red-600 text-white p-8 rounded-sm">
                  ...
                  <p className="text-white/90 font-medium mb-8">
                    Taxi nodig in Diemen? Bel ons voor directe service.
                  </p>
              ...
              <div className="bg-neutral-900 text-white p-8 rounded-sm mb-16">
                <h2 className="text-2xl font-black uppercase tracking-tighter mb-4">Taxi in Diemen</h2>
                <p className="text-neutral-300 leading-relaxed mb-6">
                  Diemen is een snel groeiende buurt aan de oost van Amsterdam met goede bereikbaarheid. Premium Taxi Amsterdam biedt snelle en betrouwbare verbindingen van Diemen naar Amsterdam, en speciaal naar Schiphol Airport met vaste tarieven.
                </p>
                <p className="text-neutral-300 leading-relaxed">
                  Of u naar the hart van Amsterdam gaat of naar Schiphol voor uw vlucht - wij brengen u snel en veilig.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <Link href="/schiphol" className="p-6 border border-neutral-200 hover:border-red-600 hover:shadow-lg transition-all rounded-sm">
                  <h3 className="font-black text-neutral-900 uppercase tracking-tighter mb-2">Schiphol Info</h3>
                  <p className="text-sm text-neutral-500">Lees onze Schiphol tarieven</p>
                </Link>
