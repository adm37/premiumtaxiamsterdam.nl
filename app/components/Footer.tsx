        ...
        <div className="grid md:grid-cols-4 gap-16 mb-20">
          ...
          <div>
            ...
            <ul className="space-y-4 text-neutral-400 font-bold uppercase text-[11px] tracking-[0.2em]">
              <li><a href="#" className="hover:text-white transition-colors">AMSTERDAM CENTRUM</a></li>
              <li><a href="#" className="hover:text-white transition-colors">DE PIJP</a></li>
              <li><a href="#" className="hover:text-white transition-colors">OUD-WEST</a></li>
              <li><a href="#" className="hover:text-white transition-colors">AMSTERDAM NOORD</a></li>
              <li><a href="#" className="hover:text-white transition-colors">IJBURG & ZEEBURG</a></li>
            </ul>
          </div>
